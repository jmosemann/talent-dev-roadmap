...
export const sampleReport: HerohubReport = {
  reportTitle: '12-Month Talent Development Roadmap',
  reportSubtitle: '',
  profile: {
  ...
  preparedFrom: 'Prepared from the July 17, 2026 Talent Development Assessment',
  ...
  assessmentSnapshot: [
    ...
    { area:'One-year success', evidence:'Cliff can take more time off without worrying about day-to-day operations' },
  ],
  talentSnapshot: [
  ...
  programAssignmentIntro: 'Required events address a documented current-role gap. Recommended events add leverage when staffing coverage is workable. Optional events are useful only after the primary plan is stable. Because this is a small dealership, no more than two people should travel at once, and service should not lose both Josh and Joe simultaneously without backfill.',
  ...
  seasonalityAssumptions: 'Dealer-specific planning uses Honda Suzuki of Sanford guidance embedded in the Herohub roadmap standard. September is a shoulder month with a hunting-season bump; October-February are development months; March transitions into peak; April-June are protected peak months; July-August return to development. HerohubIQ remains active year-round.',
  roadmap: [
